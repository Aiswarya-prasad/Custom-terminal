...
PS2='... '
PATH=$PATH:/home/aiswarya/bin
string=`who am i`
i=$((${#string}-1))
if [ "${string:$i:1}" = ")" ]; then
	espeak -v f1 "SSH Login detected." &
fi

stty -ixon

# To display cool git stuff
parse_git_branch() {
...
unset __conda_setup
# <<< conda initialize <<<
# <<< modified by aiswarya to deactivate base <<<
conda deactivate
export PATH=/home/aiswarya/texlive/2019/bin/x86_64-linux:$PATH
